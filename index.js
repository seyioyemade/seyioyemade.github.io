...
const projects = [
...

  {
    ...
    description:
      "Twenties Leadership Summit is a developmental program designed to create a profound shift in the thinking and behavior of twenties.",
    featuredImage: "images/work1.png",
    technologies: ["javaScript", "css", "html"],
    linkToLiveVersion:
      "https://seyioyemade.github.io/twenties-leadership-summit-2023/",
    linkToSource:
      "https://github.com/seyioyemade/twenties-leadership-summit-2023",
  },

  {
    name: "Fela Durotoye Website",
    dept: {
      name: "GEMSTONE Leadership Institute",
      role: "WordPress Dev",
      year: 2023,
    },
    description:
      "Fela Durotoye is a Senior Special Assistant to Nigeria President. He's highly regarded as one of Africa’s leading Executive Coaches. He is an official member of the Forbes Coaches Council (an invitation-only community for senior-level executives in the global coaching industry)",
    featuredImage: "images/FelaDurotoye.png",
    technologies: ["WordPress", "javaScript", "css", "html"],
    linkToLiveVersion: "https://feladurotoye.net",
    linkToSource: "#",
  },

  {
    ...
    description:
      "Capital Film Production is a film fund that supports the growth of the African film industry through funding to global prominence and profitability.",
    featuredImage: "images/cfp.png",
    technologies: ["WordPress", "javaScript", "css", "html"],
    linkToLiveVersion: "https://capitalfilmproductions.com",
    linkToSource: "#",
  },
];
...
form.addEventListener("submit", (event) => {
  if (emailRegExp.test(userEmail.value)) {
    ...
    emailError.textContent =
      "Your responses were not sent. Kindly ensure your email address is in lower case.";
